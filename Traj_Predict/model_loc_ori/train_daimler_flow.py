...
def train_loc_ori(dataset='daimler',
    ...
    if train_test < 2:
        ...
        beh_seq_val = []
        beh_seq_train = load_dict('Train_aug_Stopping')
    ...
    if train_test > 0:
        beh_seq_test = load_dict('TestV_Stopping')
...
if __name__ == '__main__':
    try:
        ...
        raise ValueError('Usage: python train_test.py <train_test>\n'
                         'train_test: 0 - train only, 1 - train and test, 2 - test on By\n')
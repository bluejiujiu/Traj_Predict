...
def draw_tte_all(model_path):
    ...
    perf_loc_offset_ori = load_dict('loc_offset_ori/TTE')
    perf_loc_offset_ori_speed = load_dict('loc_offset_ori_speed/TTE')
    #print(perf_loc)
...
def daimler_test(data_test, model_path='', speed_model_path='', bbox_type='Interframe_offset'):
    ...
    if 'obd_speed' in model_opts['dec_input_type']:
        ...
        # speed
        test_results = test_model.predict([test_data['enc_input'], speed_results], batch_size=2056, verbose=1)
